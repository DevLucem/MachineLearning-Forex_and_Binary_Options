...
class rsxValues():
    ...
    def values(self):
        values = [self.v4_,self.f90_,self.f88,self.f8,self.f28,self.f30,self.f38,self.f40,self.f48,self.f50,self.f58,self.f60,self.f68,self.f70,self.f78,self.f80]
        return(values)
...
class neuralValues():
    ...
    def values(self):
        values = [self.l1_2, self.l2_1, self.l2_5, self.l2_9, self.l2_13, self.l2_17, self.l2_21, self.l2_25, self.l2_29, self.l2_32, self.l3_0]
        return(values)
...
with open(outputFile, 'a', newline='') as data_file:
    entryWrite = csv.writer(data_file)
    entryWrite.writerow(['time', 'open', 'high', 'low', 'close', 'ohlc', 'change','big_source', 'v4_', 'f90_', 'f88', 'f8','f28','f30','f38','f40','f48','f50','f58','f60','f68','f70','f78','f80','l1_2','l2_1','l2_5','l2_9','l2_13','l2_17','l2_21','l2_25','l2_29','l2_32','l3_0','signal', 'y'])
